...
%TODO Previous version comparison to version 1809: Size and benchmark + Subsection titles revisions
In this final section a comparison shall be made between the Windows Server, Windows Server Core and Windows Server Nano container images. At first the advantages of the usage of the new version of the images shall be discussed. This involves a comparison, between version 1709 and 1809, of the size of the base images and the performance when performing task XXXX. Afterwards the different purposes of the various images will be analysed. These images have been tested in a Docker environment as described in the following subsection.

\subsection{Technical specifications of Docker environment}
%TODO: Installatiestappen Azure VM in Appendix
%TODO: Technische Specificaties Standard DS1 v2 (1 vcpus, 3.5 GB memory)
% Windows Server 2019
%docker image pull mcr.microsoft.com/windows:1809
%docker image pull mcr.microsoft.com/windows/servercore:1809
%docker image pull mcr.microsoft.com/windows/nanoserver:1809  
% Windows Server 2016 SAC 1709
%docker image pull mcr.microsoft.com/windows DOES NOT EXIST 
%docker image pull mcr.microsoft.com/windows/servercore:1709 
%docker image pull mcr.microsoft.com/windows/nanoserver:1709   
% Windows Server 2016 1609
%docker pull microsoft/windowsservercore
%TODO docker pull microsoft/nanoserver
%TODO docker pull microsoft/server
%TODO Grote vergelijken met docker images --> CSV --> RStudio
