...
\label{sec:SAP}
When migrating a server, it is of great importance to ensure that all dependencies have been met. 
...
\subsubsection{Verification}
After a successful migration, the operation of the SAP solution will be verified.
