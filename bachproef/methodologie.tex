...
\begin{figure}[h]
	\begin{subfigure}{0.5\textwidth}
	\captionsetup{width=0.8\linewidth}
	\includegraphics[width=0.9\linewidth]{img/Verification_WS_0.png}
	\centering
	\caption{Download and open the \acrshort{rdp} file}
	\label{fig:verification0}
\end{subfigure}
\begin{subfigure}{0.5\textwidth}
	\captionsetup{width=0.8\linewidth}
	\includegraphics[width=0.9\linewidth]{img/Verification_WS_1.png} 
	\centering
...
% Promote to DC 2019
% Verify connection
% Remove DC 2016 from environment
% Verify DC 2019
\subsubsection{Verification}
