...
Some of them with only a handful of employees to corporations that have a couple of thousand at their disposal. 
...
This can bring tremendous damage to the business value of any organization since \acrshort{it} has become a core business for many of them. 
...
Since the release of Windows Server 2019, the latest version, many organizations are willing to investigate a migration from previous versions of the \acrshort{os} in the nearby future. 
