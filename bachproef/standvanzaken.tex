...
\begin{description}
\item [Azure Active Directory authentication] Provides access to Azure Active Directory which adds an additional layer of security and ease of management and scalability.
...
\begin{figure}[h]
	...
	\caption{\acrlong{hci}}
	\scriptsize	
	Adapted from \autocite{Woolslayer2018}
	\label{fig:HCI}
\end{figure}
...
%\begin{description}
% TODO Implementeren of laten vallen?
