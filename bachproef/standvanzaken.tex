...
\section{Security}
%\subsection{Windows Defender Advanced Threat Protection (ATP)}
%\subsection{Security with Software Defined Networking (SDN)}
%\subsection{Shielded Virtual Machines improvements}
%\subsection{HTTP/2 for a faster and safer Web}
...
%https://thestack.com/data-centre/2017/06/26/hyperconverged-market-grows-64-over-2016/