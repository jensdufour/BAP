...
This means, on top of the additional infrastructure costs, that they require the same number of man-hours that comes with the management of a traditional data centre. 
...
As will be discussed in Chapter \ref{ch:toekomstvisie}, new features will be introduced several times a year to improve the overall experience with the \acrlong{wac}.
