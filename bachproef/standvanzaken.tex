...
While virtualization detaches computing environments from their physical infrastructure through software, cloud computing is a service that delivers computing resources on demand through a network.\autocite{Naeem2016}
...
This means that it can be managed in-house or by a third-party organization operating inside the same community. 
...
Meaning that it is a viable alternative to organizations that have some security concerns with the usage of a public cloud, but are willing to make some sacrifices in favour of a cost reduction. 
\\
...
A hybrid cloud is a contraption of two, or more, of the previously mentioned types. 
...
Nowadays this feature is known as \acrfull{wac}, previously it was known as Project Honolulu. 
...
As will be discussed in Chapter \ref{ch:toekomstvisie}, new features will be introduced several times a year to improve the overall experience with \acrlong{wac}.
...
Another new feature is the addition of support for Ubuntu, Red Hat Enterprise Linux and SUSE Linux Enterprise Servers (SLES) inside Shielded \acrshort{vm}s. 
...
Since Windows Server 2019 it is now possible to run Linux containers on the same container host, utilizing the same Docker daemon. 
