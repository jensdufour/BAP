...
%Bron: https://docs.microsoft.com/en-us/windows-server/manage/windows-admin-center/plan/azure-integration-options
\begin{description}
...
%TODO Add caption and source
%https://github.com/MicrosoftDocs/windowsserverdocs/raw/master/WindowsServerDocs/manage/windows-admin-center/media/WindowsAdminCenter1809Poster.pdf
\begin{figure}[h]
...
\section{Conclusion}
%TODO Rewrite and conclude
%In-place upgrades are one of the areas that Microsoft focused heavily during the release. In place upgrades from Windows Server 2016 to 2019, should be relatively safe. As always, make sure you have a backup before attempting an upgrade of this manner.
